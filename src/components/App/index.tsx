...
export default function Application() {
  ...
  //const BUNDLER_URL = `https://api.pimlico.io/v2/${chain.id}/rpc?apikey=${process.env.NEXT_PUBLIC_PIMLICO_API_KEY}`
  //const PAYMASTER_URL = `https://api.pimlico.io/v2/${chain.id}/rpc?apikey=${process.env.NEXT_PUBLIC_PIMLICO_API_KEY}`
    ...
    <SafeProvider config={safeConfig}>
      ...
      <div className="card" id="forms">
        <div className="section">
          ...
          <div>
            <p>
              Applications can have different input fields to create forms like
              the one below. There are two types of fields: text, and number.
            </p>
      ...
      <div className="card" id="buttons">
        <div className="section">
          ...
          <div>
            <p>
              Applications can have buttons of two types: primary and secondary
              buttons.
            </p>
        ...
        <div className="section">
          ...
          <div>
            <p>
              ...
              buttons. All of these elements are optional and can be combined in
        ...
        <div className="section">
          ...
          <div>
            <p>
              ...
              each box, you can add a title, paragraphs, links, callouts, forms,
              and buttons. All of these elements are optional and can be
              combined in many ways to suit your needs.
            </p>
            <div className="box">
              <p>
